...
import { IoMenuOutline, IoNotificationsSharp, IoPersonCircle, IoSettingsOutline, IoLogOutOutline } from "react-icons/io5";
import {
    renderThumb,
    renderTrack,
    renderView,
...
function Navbar(props) {
    ...
    return (
        <Flex display={{ sm: "none", xl: "block" }} position='fixed' minW='100%' h="8vh" minH="8vh">
            <Flex
                direction="row"
                bg={backgroundColor}
                w='100vh'
                ...
                {/** Menu Button */}
                <Box w='max-content' h='max-content' onClick={handleMenuButtonClick} p="5">
                    <Icon
                        as={IoMenuOutline}
                            ...
                            <Scrollbars
                                ...
                                {notifications.map((notification) => (
                                    <MenuItem icon={
                                        ...
                                        <Text fontSize="md" color={textColor}>{notification[0]}</Text>
                                    </MenuItem>
                                ))}
                            </Scrollbars>
                        </MenuList>
