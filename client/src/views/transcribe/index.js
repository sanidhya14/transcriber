...
import {
  MdRunCircle, MdFileOpen, MdSettings, MdMore, MdOutlineDone, MdDone, MdDoneAll, MdOutlinePlaylistAddCheckCircle
} from "react-icons/md";
...
import { GoCheck, GoCircle } from "react-icons/go";
...
export default function Transcribe() {
  ...
  const getPage = (devPage) => {
    switch (devPage) {
      case 0:
        return <Card p="1rem" height="100%" width="100%">
          <FileSelector height="100%" width="100%"></FileSelector>
        </Card>

      case 1:
        return <Card p="1rem" height="80vh" width="100%" overflowY="auto">
          ...
          <FormControl mb={4}>
            ...
            <RadioGroup value={transcriptionMode} onChange={setTranscriptionMode}>
              <Stack spacing={2}>
      ...
      case 2:
        return <Card p="1rem" height="80vh" width="100%" align='center'>
          <Card p="1rem" height="100%" width="100%" align='center'>
            ...
            <Center>
              <Flex direction="row" justify="space-between" mt={4}>
                <Button colorScheme="blue" ml={2} mr={2} >See Transcript</Button>
              </Flex>
            </Center>
          </Card>
        </Card>
    ...
    <Box pt={{ base: "130px", md: "80px", xl: "80px" }} height="100vh">
      ...
      >
        ...
        <Card p="1rem" height="100%" width="100%">
          ...
          {/* Small Layout */}
          <Flex direction="row" justify="space-between" mt={4}>
            <Button colorScheme="blue" ml={2} mr={2} >Next</Button>
          </Flex>
        </Card>
      </Grid>
    </Box>
